    ...
    <main id="main" class="site-main">
      ...
      <div class="entry-content">
        <section id="rectangle_one" class="height-75 py-5 width-100 bg-light">
          ...
          <a href="#block_1"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-arrow-down-circle d-flex justify-content-start" viewBox="0 0 16 16">
