    ...
    <div class="container h-100 d-flex align-items-center justify-content-star">
        <div class="element">
            ...
            <div class="d-flex flex-row">
                <a class="btn btn-secondary learn_more d-flex align-items-center justify-content-center"
        ...
        <a href="#block_1" class="scroll_down"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
            class="bi bi-arrow-down-circle d-flex justify-content-start" viewBox="0 0 16 16">
