            ...
            <div class="card mb-3 d-flex">
                <div class="row" style="margin-left: 0px;">
                    <div class="col-2 bookmark_svg"> 
                        ...
                        <p class="col-10 text-left p-4 m-0"><?php echo get_field('text_one_block_6')?></p>
                </div>
            </div>
            <div class="card mb-3 d-flex">
                <div class="row" style="margin-left: 0px;">
                    <div class="col-2 bookmark_svg"> 
                        ...
                        <p class="col-10 text-left p-4 m-0"><?php echo get_field('text_two_block_6')?></p>
                </div>
            </div>
            <div class="card mb-3 d-flex">
                <div class="row" style="margin-left: 0px;">
                    <div class="col-2 bookmark_svg"> 
                        ...
                        <p class="col-10 text-left p-4 m-0"><?php echo get_field('text_three_block_6')?></p>
                </div>
            </div>
            <?php if(get_field('text_four_block_6')): ?>
                ...
                <div class="row" style="margin-left: 0px;">
                    <div class="col-2 bookmark_svg"> 
                        ...
                        <p class="col-10 text-left p-4 m-0"><?php echo get_field('text_four_block_6')?></p>
                </div>
            </div>
            <?php endif;?>
        </div>
